                                                ...
                                                <TouchableOpacity style={{zIndex: 99, elevation: 4,borderWidth:0, borderRadius:12,backgroundColor:'#fafafa'}}>
                                                    <View style={{borderWidth:0, borderRadius:12, backgroundColor:'#fafafa'}}>
                                                        ...
                                                        <Avatar
                                                            ...
                                                            { item.paid != 'no' ?
                                                               <View style={{justifyContent:'flex-end', flexDirection: 'row', width: wp('20%')}}>
                                                                <Text style={{ fontFamily:"Poppins-SemiBold",fontSize: hp("1.6%"),color: "black", paddingLeft: 5}}>Paid</Text>
                                                                <Image resizeMode="contain" source={require('./../../../Assets/Images/accept.png')} style={{width:12, height: 12, margin:5}} />
                                                              </View>:
